  ...
  const tabData = {
    clinical: {
      ...
      stats: [
        {
          p: 47,
          l: 'Australians with Chronic Conditions',
          d: 'Nearly half of the population suffers from 1+ chronic conditions.'
        },
        {
          p: 85,
          l: 'Condition Improvement with Exercise',
          d: 'Exercise is a Tier 1 treatment for Type 2 Diabetes, CVD, and Osteoporosis.'
        }
      ],
    ...
    general: {
      ...
      stats: [
        {
          p: 15,
          l: 'Adults Meeting Activity Guidelines',
          d: 'Most adults fail to meet the required strength training guidelines.'
        },
        {
          p: 40,
          l: 'Reduced Mortality Risk',
          d: 'Regular resistance training is linked to a 40% reduction in all-cause mortality.'
        }
      ]
    },
    athlete: {
      ...
      stats: [
        {
          p: 55,
          l: 'Injury Risk Reduction',
          d: 'Structured S&C programs reduce sports injury rates by over half.'
        },
        {
          p: 22,
          l: 'Performance Output Increase',
          d: 'Average power output increase after 12 weeks of periodized training.'
        }
      ]
    }
  };
  ...
  return (
    <div className="min-h-screen bg-[#0E0E0E] text-white font-sans selection:bg-[#6A1E2B] selection:text-white">
      ...
      <header className="relative min-h-[85vh] flex items-center justify-center overflow-hidden border-b border-[#222]">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10 text-center flex flex-col items-center animate-in fade-in slide-in-from-bottom duration-1000">
          <div className="flex items-center justify-center gap-4 mb-8">
            ...
            <span className="text-[#B0B0B0] tracking-[0.3em] uppercase text-xs md:text-sm font-semibold">
          ...
          <h1 className="text-7xl md:text-9xl font-black tracking-tighter leading-[0.9] mb-8">
            PRJCT: <br />
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-white to-[#B0B0B0]">
              LEGACY
            </span>
          </h1>
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <button
              onClick={() =>
                document.getElementById('distinction')?.scrollIntoView({ behavior: 'smooth' })
              }
      ...
      <section
        ...
        className={`bg-[#0a0a0a] border-b border-[#222] transition-all duration-1000 ${
          isVisible.distinction ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
        }`}
      >
        <div className="w-full py-20 md:py-32 px-6 md:px-12 max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Physio vs. <span className="text-[#6A1E2B]">Physiology</span>
            </h2>
            <div className="h-1 w-20 bg-[#222] mx-auto mb-6"></div>
            <p className="text-[#B0B0B0] text-lg leading-relaxed">
              Many confuse Exercise Physiology (EP) with Physiotherapy. While we work together,
              our roles are distinct.
              <br />
              <br />
              <span className="text-white font-medium">
                Think of Physio as the "Mechanic" fixing the acute breakdown, and EP as the
                "Engineer" optimizing the machine for the long haul.
              </span>
            </p>
          </div>
            ...
            <div className="p-8 md:p-10 rounded-2xl border border-[#6A1E2B]/50 bg-gradient-to-b from-[#1a0508] to-[#0e0e0e] relative overflow-hidden">
              ...
              <ul className="space-y-5 relative z-10">
                {[
                  ...
                  'Strength & conditioning for rehab'
                ].map((item, i) => (
      ...
      <section
        id="data"
        ref={setRef('data')}
        className={`w-full py-20 md:py-32 px-6 md:px-12 max-w-7xl mx-auto transition-all duration-1000 ${
        ...
        <div className="grid lg:grid-cols-12 gap-16">
          <div className="lg:col-span-5 flex flex-col justify-center">
            <h2 className="text-4xl font-bold mb-6">
              The Spectrum of <span className="text-[#6A1E2B]">Care</span>
            </h2>
            <p className="text-[#B0B0B0] mb-10 text-lg">
              PRJCT: Legacy operates across the entire health continuum. Whether managing a
              heart condition or preparing for a national championship, the principles of
              physiology remain the same.
            </p>
          ...
          <div className="lg:col-span-7 bg-[#111] p-10 rounded-2xl border border-[#222] flex flex-col justify-center min-h-[500px]">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 pb-6 border-b border-[#222]">
              ...
              <span className="text-[#6A1E2B] font-mono text-sm mt-2 md:mt-0 tracking-wider">
                {tabData[activeTab].tag}
              </span>
            </div>
            ...
            {tabData[activeTab].pathways && (
              <div className="mt-10 pt-6 border-t border-[#222]">
                <p className="text-sm uppercase tracking-widest text-[#555] mb-4 font-bold">
                  Pathways
                </p>
                <div className="grid grid-cols-2 gap-4">
                  {tabData[activeTab].pathways.map((path, i) => (
                    <div
                      key={i}
                      className="bg-[#1a1a1a] p-4 rounded-lg border border-[#333] text-[#B0B0B0] text-center hover:border-[#6A1E2B] transition-colors cursor-default text-sm"
                    >
                      {path}
                    </div>
                  ))}
      ...
      <section
        ...
        ref={setRef('protocol')}
        className={`w-full py-20 md:py-32 px-6 md:px-12 max-w-7xl mx-auto transition-all duration-1000 ${
          isVisible.protocol ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
        }`}
      >
        <div className="text-center mb-20">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            The Legacy <span className="text-[#6A1E2B]">Protocol</span>
          </h2>
          <p className="text-[#B0B0B0] text-lg max-w-2xl mx-auto">
            Our four-stage methodology designed to take any individual from baseline to peak
            performance.
          </p>
        </div>
          ...
          {[
            {
              step: '01',
              title: 'Assess',
              desc: 'Comprehensive musculoskeletal screening and baseline metrics.'
            },
            {
              step: '02',
              title: 'Program',
              desc: 'Bespoke prescription tailored to your pathology or goals.'
            },
            {
              step: '03',
              title: 'Adapt',
              desc: 'Progressive overload and adaptation monitored through regular testing.'
            },
            {
              step: '04',
              title: 'Overcome',
              desc: 'Surpassing limitations and establishing new physical standards.'
            }
          ].map((item, i) => (
            <div
              key={i}
              className="p-8 rounded-xl bg-[#111] border border-[#222] hover:border-[#6A1E2B]/50 transition-colors group"
            >
              <div className="text-5xl font-black text-[#222] group-hover:text-[#6A1E2B]/20 mb-4 transition-colors">
                {item.step}
              </div>
      ...
      <footer className="border-t border-[#222] bg-[#050505] py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-lg mx-auto mb-16">
            <a
              href="mailto:referrals@prjctlegacy.com"
              className="block p-8 rounded-xl bg-[#1a1a1a] border border-[#333] hover:border-[#6A1E2B] transition-all group text-left"
            >
              <h4 className="text-white font-bold text-xl mb-1 group-hover:text-[#6A1E2B] uppercase tracking-tight">
                Referrals
              </h4>
          ...
          <div className="pt-8 border-t border-[#1a1a1a] flex flex-col md:flex-row justify-between items-center text-[#444] text-sm">
            ...
            <div className="flex gap-8 mt-4 md:mt-0 font-medium">
              <a
                href="https://instagram.com/prjct_legacy"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://linkedin.com/company/prjct-legacy"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-white transition-colors flex items-center gap-2"
              >
              ...
              <a
                href="mailto:info@prjctlegacy.com.au"
                className="hover:text-white transition-colors flex items-center gap-2"
              >
                <Mail size={16} /> Email
              </a>
